...
const S={bg:"#CED5D9",card:"#FBFCFD",cl:"#E7EEF2",pri:"#0578A6",pl:"#0AAEE8",acc:"#12C265",gold:"#FFB020",dng:"#FB4B3A",txt:"#1F2D38",ts:"#7C8893",td:"#9AA6B0",brd:"#DCE3E7",ok:"#12C265",chrome:"#0578A6",chromeTop:"#036690",chromeFg:"#FFFFFF",chromeFg2:"rgba(255,255,255,0.78)"};

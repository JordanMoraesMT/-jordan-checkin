...
import { crmFire, API, DASH, HOMES, todayLocal, gcalUrl, TYPES, USERS, BRANDS, SECTORS, CAT_IDS, ORIGINS, CC, S, fT, fD, mins, hrsMin, hav, sL, sS, gps, fixMojibake, strip, fetchCNPJ, MIN_OBS } from "./lib";

...
import { crmFire, API, DASH, HOMES, todayLocal, TYPES, USERS, BRANDS, SECTORS, CAT_IDS, ORIGINS, CC, S, fT, fD, mins, hrsMin, hav, sL, sS, gps, fixMojibake, strip, fetchCNPJ, MIN_OBS } from "./lib";
...
function TarefaModal({ open, onClose, token, user, allOrgs, preOrg = null, onCreated }) {
  ...
  const criar = async () => {
    ...
    setLo(false); onCreated && onCreated(); onClose && onClose();
  };
  if (!open) return null;

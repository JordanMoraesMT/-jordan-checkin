...
import { crmFire, API, HOMES, todayLocal, TYPES, BRANDS, SECTORS, CAT_IDS, ORIGINS, CC, S, fT, fD, mins, hrsMin, hav, sL, sS, agF, agErr, postTask, gps, fixMojibake, strip, fetchCNPJ, MIN_OBS } from "./lib";
